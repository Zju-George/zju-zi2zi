...
parser.add_argument('--experiment_dir', required=False,default="experiments" ,
...
parser.add_argument('--embedding_num', type=int, default=80,
                    help="number for distinct embeddings 185")
...
parser.add_argument('--validate_steps', type=int, default=100,
                    help='number of batches in between two validations')
parser.add_argument('--validate_batches', type=int, default=2,
                    help='validation epochs 2')
